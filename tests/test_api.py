...
async def test_login_uses_antiforgery_cookie_and_json_credentials() -> None:
    ...
    assert session.calls[0][2]["headers"]["User-Agent"] == ("ELCO-Aerotop-Home-Assistant/0.3.4")
    ...
    assert session.calls[1][2]["headers"]["User-Agent"] == ("ELCO-Aerotop-Home-Assistant/0.3.4")
